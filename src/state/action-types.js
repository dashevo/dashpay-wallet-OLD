...
export const ALTERNATIVE_CURRENCY_GET_RATE_ASYNC = createAsyncStatusConstants('ALTERNATIVE_CURRENCY_GET_RATE_ASYNC');
export const ALTERNATIVE_CURRENCY_INVALIDATE_RATE = 'ALTERNATIVE_CURRENCY_INVALIDATE_RATE';
export const ALTERNATIVE_CURRENCY_SET_CURRENCY = 'ALTERNATIVE_CURRENCY_SET_CURRENCY';
